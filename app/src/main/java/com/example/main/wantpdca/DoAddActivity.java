...
public class DoAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_do_add);
        ...
        wantListBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Wantを登録する画面を起動
                Intent intent = new Intent(DoAddActivity.this, WantDetailActivity.class);
